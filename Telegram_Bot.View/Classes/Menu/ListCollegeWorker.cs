...
namespace Telegram_Bot.View.Classes.Menu
{
    public class ListCollegeWorker: MainMenu, IMenu
    {
        ...
        public async void SendMessageCollegeWorker(object sender, MessageEventArgs e)
        {
